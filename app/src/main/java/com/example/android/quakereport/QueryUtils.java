...
public final class QueryUtils {
     ...
     * Return a list of {@link Edata} objects that has been built up from

     * parsing a JSON response.

     */

    public static ArrayList<Edata> extractEarthquakes() {



        // Create an empty ArrayList that we can start adding earthquakes to

        ArrayList<Edata> earthquakes = new ArrayList<>();
